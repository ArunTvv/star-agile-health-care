         ...
         stage('Test Results'){
          ...
          steps {
            echo 'this is for ansible'
              ansiblePlaybook credentialsId: 'sshkey', disableHostKeyChecking: true, installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: 'app-deploy.yml', vaultTmpPath: ''
          }
        }
      }
}
